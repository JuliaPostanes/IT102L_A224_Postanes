...
## Program Description: This program analyzes the transactions recorded in 
#                        the transactions.txt file and provides a summary for everything.
## Reflection: I learned how to read from a file, process the data, 
#                           and calculate a lot of statistics related to the transactions.
