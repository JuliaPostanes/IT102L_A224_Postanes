...
# Used by both record_transaction() and
# get_transactions() so the write format and
# the read format can never be apart from each other.
AMOUNT_PREFIX = "Amount: ₱"
BALANCE_AFTER_PREFIX = "Balance After: ₱"
